...
class WACNN2(CompressionModel):
    ...
    def forward(self, x):
        ...
        # time2 = time.time()
        # print("teacher time",time2 - time1)

        y = self.g_a(x)
        y_shape = y.shape[2:]
        # time3 = time.time()
        # print("encoder time",time3 - time2)
        z = self.h_a(y)
        ...
        # time4 = time.time()
        # print("encoder z time",time4 - time3)
        ...
        # time5 = time.time()
        # print("hyper time",time5 - time4)

        x_hat = self.g_s(y_hat)
        decompressH = x_hat
        # time6 = time.time()
        # print("decoder time",time6 - time5)

        Student_compressH, Student_output_features, Student_classification, Student_regression, Student_anchors, scores, labels, boxes = self.studentNet(
            decompressH)
        compressH,Teacher_output_features = 0,0
        return {
            "compressH": compressH,
